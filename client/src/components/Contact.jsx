...
function Contact() {
 ...
 useEffect(()=>{
  ...
  return (
    <>
      <div className="contact"><h1 className='text-3xl font-bold my-3 '>Contact Us</h1></div>
      <section className='contact_section bg-white'>


        <div className="contact_subsection1">
        ...
        <div className="contact_subsection2">
          <div className="contact_content_subsection2">
            ...
            <form onSubmit={handleForm}>
              ...
              <input type="text" name="message" id="message" onChange={handleValue} /><br />
              <br />
