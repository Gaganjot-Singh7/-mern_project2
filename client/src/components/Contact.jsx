...
function Contact() {
  ...
  const handleForm = async (e) => {
    ...
    if (response.ok) {
      console.log("check  Contact database");
  ...
  return (
    <>
      ...
      <section className="contact_section grid grid-cols-1 lg:grid-cols-2 gap-8 justify-center">

        <div className="contact_subsection1 px-9 py-9 my-10 mx-10" >
        ...
        <div className="contact_subsection2">
          <div className="contact_content_subsection2 text-center">

            <form onSubmit={handleForm} className="space-y-4 m-8">
              <div>
                <label htmlFor="username" className="block">Username:</label>
                <input type="text" name="username" id="username" onChange={handleValue} className="border border-gray-300 rounded px-3 py-2 w-full" />
              </div>
              <div>
                <label htmlFor="email" className="block">Email:</label>
                <input type="email" name="email" id="email" onChange={handleValue} className="border border-gray-300 rounded px-3 py-2 w-full" />
              </div>
              <div>
                <label htmlFor="message" className="block">Message:</label>
                <textarea name="message" id="message" rows="4" onChange={handleValue} className="border border-gray-300 rounded px-3 py-2 w-full"></textarea>
              </div>
