...
import useAuth, { AuthContext } from '../store/Store.jsx';
  ...
  return (
    <>
      ...
      <div className="login_section">
        <div className="login_subsection1">
        ...
        <div className="login_subsection2">

          <div className="login_subsection2_content">
            <form onSubmit={handleForm}>
              <label htmlFor="email">Email: </label>
              <input type="text" name="email" id="email" onChange={handleValue} />
              <br />
  ...
  <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
    ...
    <div className="mt-4">
      <form onSubmit={handleForm} className="flex flex-col space-y-4">
        ...
        <input type="text" name="email" id="email" onChange={handleValue} className="border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:border-blue-500" />
        <label htmlFor="password" className="text-lg">Password:</label>
        <input type="password" name="password" id="password" onChange={handleValue} className="border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:border-blue-500" />
        <button type="submit" className="bg-blue-500 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300">Login</button>
      </form>
    </div>
  </div>
</div>
